...
const CreateBlogPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Submitted Blog:', {
            ...blogData,
            author: 'Jane Doe', // Replace with real user data
                ...
                <div className="bg-white shadow-xl rounded-2xl p-6 md:p-10 transition-all duration-300">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                                Publish Blog
                            </button>
                        </div>
